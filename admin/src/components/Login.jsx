      ...
      <div className='bg-gray-100 shadow-md rounded-lg  px-8 py-6 max-w-md'>
        ...
        <form onSubmit={onSubmitHandler}>
            <div className='mb-3 min-w-72'>
                <p className='text-sm font-medium txt-gray-700 mb-2'>Email Address</p>
            ...
            <div className='mb-3 min-w-72'>
                <p className='text-sm font-medium txt-gray-700 mb-2'>Password</p>
                <input onChange = {((e) => setPassword(e.target.value))} value={password} className= 'rounded-md w-full px-3 py-2 border border-gray-300 outline-none' type="password" placeholder='Enter your password' required/>
            </div>
            <button className = 'mt-2 w-full py-2 px-4 rounded-md text-white bg-gray-600' type='submit'>Login</button>
        </form>
      </div>
    </div>
  )
